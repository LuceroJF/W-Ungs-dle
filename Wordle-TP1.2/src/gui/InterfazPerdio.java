...
public class InterfazPerdio {
	...
	public InterfazPerdio(Usuario usuario) 
	{
	...
	private void initialize() 
	{
		...
		etiquetaImagenGano.setIcon(new ImageIcon(InterfazGano.class.getResource("/recursos/perdiste.png")));
		etiquetaImagenGano.setBounds(133, 188, 736, 311);
